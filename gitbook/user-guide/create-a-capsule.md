...
- **NFTs**: available when the app can read NFTs from Helius DAS or Solana token accounts.
...
The repository default is a 0.05 SOL creation fee, configured through the fee configuration account and constants. Production values should be displayed clearly in your UI before users sign.
